# functions from the great repo https://github.com/jzhangbs/DTUeval-python, check it out!
...
def evaluate_mesh(inp, scan_id, dataset_dir, eval_dir, suffix='', save_viz=True):
    ...
    with open(f'{eval_dir}/dtu_scores{suffix}.tsv', 'w') as f:
        f.write(f'acc\tcomp\tavg\n')
        f.write(f'{mean_d2s}\t{mean_s2d}\t{avg}')
        print_log('dtu_scores{}: acc={:.5f}, comp={:.5f}, avg={:.5f}'.format(suffix, mean_d2s, mean_s2d, avg))
